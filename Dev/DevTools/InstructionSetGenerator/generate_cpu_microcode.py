...
instruction_set = [
    ...
    {   'name': 'jp_addr',
        ...
        'flags': fetch + [ 0x40004, 0x0010C, 0x00042 ] + fin_inst
    },
    {   'name': 'jpz_addr_zf0',
        'op_code': 0x0C, 'cf': [0, 1], 'zf': 0,
        'flags': fetch + [ 0x00008 ] + fin_inst
    },
    {   'name': 'jpz_addr_zf1',
        'op_code': 0x0C, 'cf': [0, 1], 'zf': 1,
        'flags': fetch + [ 0x40004, 0x0010C, 0x00042 ] + fin_inst
    },
    {   'name': 'jpc_addr_cf0',
        'op_code': 0x0D, 'cf': 0, 'zf': [0, 1],
        'flags': fetch + [ 0x00008 ] + fin_inst
    },
    {   'name': 'jpc_addr_cf1',
        'op_code': 0x0D, 'cf': 1, 'zf': [0, 1],
        'flags': fetch + [ 0x40004, 0x0010C, 0x00042 ] + fin_inst
    },
    {   # return to saved position
        'name': 'rts',
        'op_code': 0x0E, 'cf': [0, 1], 'zf': [0, 1],
        'flags': fetch + [ 0x20002 ] + fin_inst
    },
    {   # loop-back
        'name': 'lb',
    ...
    {   # loop-back-if-carry
        'name': 'lbc_0',
        'op_code': 0x11, 'cf': 0, 'zf': [0, 1],
        'flags': fetch + [0x00008] + fin_inst
    },
    {   # loop-back-if-carry
        'name': 'lbc_1',
        'op_code': 0x11, 'cf': 1, 'zf': [0, 1],
        'flags': fetch + [0x0010C, 0x00042] + fin_inst
    },
    {   # return on carry
        'name': 'rtc_0',
        'op_code': 0x12, 'cf': 0, 'zf': [0, 1],
        'flags': fetch + [ 0x0 ] + fin_inst
    },
    {   # return on carry
        'name': 'rtc_1',
    ...
    {   # load number into PC register
        'name':'lpc_num',
        'op_code': 0x14, 'cf': [0, 1], 'zf': [0, 1],
        'flags': fetch + [ 0x0010C, 0x40040 ] + fin_inst
    },
    {   # load number by reference into PC register
        'name':'lpc_addr',
        'op_code': 0x15, 'cf': [0, 1], 'zf': [0, 1],
        'flags': fetch + [ 0x0010C, 0x00140, 0x40040 ] + fin_inst
    },
    {   # save value of PC register
        'name':'spc',
        'op_code': 0x16, 'cf': [0, 1], 'zf': [0, 1],
        'flags': fetch + [ 0x0010C, 0x00140, 0x20080 ] + fin_inst
    },
    {   # clear contents of graphic display
        'name':'dc',
        'op_code':0x17, 'cf':[0,1], 'zf':[0,1],
        'flags': fetch + [0x400000] + fin_inst
    },
    {   # clear contents of terminal
        'name':'tc',
        'op_code':0x18, 'cf':[0,1], 'zf':[0,1],
        'flags': fetch + [0x1000000] + fin_inst
    },
    {   # clear contents of terminal
        'name':'tw',
        'op_code':0x19, 'cf':[0,1], 'zf':[0,1],
        'flags': fetch + [0x0010C, 0x40, 0x40, 0x2000000] + fin_inst
    },
    {
        'name':'dw',
        'op_code':0x1a, 'cf':[0,1], 'zf':[0,1],
        'flags': fetch + [0x0010C, 0x40, 0x40, 0x800000] + fin_inst
    },
    {
        'name':'dw_addr',
        'op_code':0x1b, 'cf':[0,1], 'zf':[0,1],
        'flags': fetch + [0x0010C, 0x00140, 0x40, 0x40, 0x800000] + fin_inst
    },
    {   # returns first 4-bit of A-Register (8Bit)
        'name':'co',
        'op_code':0x1c, 'cf':[0,1], 'zf':[0,1],
                         #|1st 4bit|
        'flags': fetch + [0x60004000] + fin_inst
    },
    {   # returns last 4-bit of A-Register (8Bit)
        'name':'ct',
        'op_code':0x1d, 'cf':[0,1], 'zf':[0,1],
        'flags': fetch + [0x20004000] + fin_inst
    }



    # 0x40004   -> save to C-Register
    #           -> load the C-Register content
    #
  #{   # save value from RAM with position of A-Register into B-Register
    #    'name':'sba',
    #    'opcode': 0x1c, 'cf': [0, 1], 'zf': [0, 1],
    #    'flags': fetch + [  ] + fin_inst
    #},
    #{
    #    'name':'ddp',
    ...
    #
    #   save caller-location until a "rts" has been detected.
    #   Making loops possible.
    #


    #                                                     ____ORIGINAL____
    # Jump Instruction -> [ save position to C-Register , 0x0010C, 0x00042 ]
    #
    # RTS -> [ load C-Register , save position-value ]
]
