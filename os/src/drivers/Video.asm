...
DrawBootLogo:
    ...
    ; Draw tomato soup can from sprite data (centered)
    LDI REA, #25
    LDI REB, #21
    LDI REC, #0x0F
    LDI REX, TomatoSoupCanSprite
    CALL DrawBitmapMono
...
; Can of tomato soup for boot logo (14 pixels wide, 21 pixels tall)
; Simple cylindrical can shape with label area
TomatoSoupCanSprite:
    DW #14, #21
    DW #0x1F4000         ; Row 0:  ...#####...
    DW #0x3FC000         ; Row 1:  ..#######..
    ...
    DW #0xFFFC00         ; Row 5:  ############
    DW #0xFFFC00         ; Row 6:  ############
    DW #0xFF8400         ; Row 7:  ########.#.. (label pattern)
    DW #0xFFF400         ; Row 8:  ###########.
    DW #0xFFFC00         ; Row 9:  ############
    DW #0xFFFC00         ; Row 10: ############
    DW #0xFFFC00         ; Row 11: ############
