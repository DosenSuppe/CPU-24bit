...
The "[Stack]() is used to store values for [CALL](./CALL_RTS.md), [INT](./INT.md) and [PUSH](./PUSH_POP.md) instructions. 
...
## GET_SP
The GET_SP instruction loads the current value of the stack pointer in a [Register](../../CpuParts/Register.md).
